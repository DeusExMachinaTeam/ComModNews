...
---
### ☀️ Мод-дайджест - Июнь 2023 [2023.06.29]
...
* **Extra Machines 1.0.4**, свежий билд крутого мода добавляющего в игру новые играбельные машины.
...
* **Different things 1.2.0**, мод солянка с новым оружием, авто и геймплейными правками. Совместим с несколькими другими модами, подталкивая к созданию своей сборки.

Плюс вышла парочка микро-модов:
* "Плавные переходы между локациями", микро-мод с несомненно звучным именем. Ну, зато можно сразу догадаться что он делает.
* "Расширенная система ранжирования аффиксов оружия для комрем". Эм, спасибо авторам микро-модов за классные имена 👍 Перекрашивает аффиксы для красоты и удобства, если вы не догадались.
...
Скачать можно на нашем Gihub: [CommunityRemaster 1.14](https://github.com/DeusExMachinaTeam/EM-CommunityPatch)
