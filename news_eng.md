...
---
### 🌊 Mod Digest - First Half of Summer 2025 [2025.07.21]
...
* **[ATM — Another Tank Mod [RU only]](https://forum.deuswiki.com/t/atm-another-tank-mod/3065/1)** - adds a new fully playable tank called Chieftain to the game, tailored to the realities of the game. This is not the first mod for tracked vehicles, but it is pleasing in how neatly the new content has been integrated into the game. *(Author: funnyscout)*
* **[〽️ MoreAmmo](https://github.com/FlyApp1e/MoreAmmo)** - instead of using the same ammunition for all gun types, the mod features about 10 different calibers of bullets, cartidges and shells with different costs - and all the guns have also have a limited ammunition. *(Author: FlyApple)*
* **[〽️ JustAnotherBalanceMod (JABM)](https://github.com/FlyApp1e/HTA-JustAnotherBalanceMod)** - a mod that changes the balance of prices in the game, with the aim of preventing players from accumulating millions in capital by the middle of the game. In combination with MoreAmmo, it significantly reshapes the economy. *(Author: FlyApple)*
...
We don't want to clutter up this resulting mega-digest with unnecessary information, so we'll just note that to install merge mods, you'll need the latest version of ComMod, no older than 3.0.6 — we recommend updating if you're still using an older version.

* 🟠 **You can get up-to-date ComMod 3.0.6** [on our Github](https://github.com/DeusExMachinaTeam/EM-CommunityPatch/releases), and compatible mods on our [Discord server](https://discord.gg/deus-ex-machina-522817939616038912) or [our new forum](https://forum.deuswiki.com/mods)
* 🔴 Watch the ["Another Tank Mod" trailer on YouTube](https://www.youtube.com/watch?v=e32-C4-gXOk)
